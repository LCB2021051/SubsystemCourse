...
APressurePlate::APressurePlate()
{
	...
	Transporter = CreateDefaultSubobject<UTranspoter>(TEXT("Transpoter"));
...
void APressurePlate::Tick(float DeltaTime)
{
	...
	if(HasAuthority())
	{
		...
		for(int ActorIndex = 0; ActorIndex < OverlapingActors.Num(); ++ActorIndex )
		{
			AActor* A = OverlapingActors[ActorIndex];
